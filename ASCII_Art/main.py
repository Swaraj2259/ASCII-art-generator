...
save_label.grid(row=3, column=0, sticky="w", padx=10, pady=10)
save_var = ttk.Combobox(root, values=["txt", "png", "both", "none"], style='TCombobox')
save_var.grid(row=3, column=1, padx=10, pady=10)
save_var.set("both")

generate_button = ttk.Button(root, text="Generate ASCII", command=generate_ascii, style='TButton')
generate_button.grid(row=4, column=0, columnspan=4, padx=10, pady=20)
